...
<#assign
    ...
    expiration=msg("emails.invite.expiresIn", linkExpirationFormatter(linkExpiration))
    fallbackIntro=msg("emails.fallbackIntro")
    fallbackLabel=msg("emails.invite.fallbackLabel")
    securityNote=msg("emails.invite.security")
    disclaimer=msg("emails.invite.disclaimer")
