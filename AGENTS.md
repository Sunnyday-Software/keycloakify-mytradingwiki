...
- `shared/assets/` is a git submodule with shared assets from `mytradingwiki-assets`.
...
- To update assets: `git submodule update --remote shared/assets` and commit the pointer.
